...
//         `https://rnlbc-202-191-174-130.a.free.pinggy.link/fetch_ipo_news?company_name=${formattedCompanyName}`
//       );
...
const News = () => {
  ...
  const fetchNews = async () => {
    try {
      ...
      const response = await axios.get(
        `https://rnlbc-202-191-174-130.a.free.pinggy.link/fetch_ipo_news?company_name=${encodeURIComponent(companyName)}`,
